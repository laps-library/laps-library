...
const styles = StyleSheet.create({
  ...
  title: { fontWeight: 'bold', fontStyle: 'italic', textTransform: 'uppercase', fontSize: 26, color: '#fff', letterSpacing: 1, textAlign: 'center' },
  block: { gap: 6 },
  h: { color: '#ff2bd6', fontWeight: 'bold', fontStyle: 'italic', textTransform: 'uppercase', fontSize: 14, letterSpacing: 1 },
