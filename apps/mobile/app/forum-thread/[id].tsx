  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <TextInput style={[styles.input, styles.reply]} value={reply} onChangeText={setReply} placeholder="Ta réponse..." placeholderTextColor="#8e8e93" multiline numberOfLines={3} textAlignVertical="top" />
...
const styles = StyleSheet.create({
  ...
  title: { fontWeight: 'bold', fontStyle: 'italic', textTransform: 'uppercase', fontSize: 24, color: '#fff', paddingBottom: 8, letterSpacing: 1 },
  label: { color: '#fff', marginTop: 8, fontWeight: 'bold', fontStyle: 'italic', textTransform: 'uppercase', letterSpacing: 1 },
  card: { borderWidth: 1, borderColor: '#444', borderRadius: 12, padding: 14, gap: 6, backgroundColor: '#000' },
